...
| `spec-01-03` | decision-log-auto | P? | Merged | `specs/spec-01-03-decision-log-auto/` |
| `spec-01-04` | flows-autoref-review | P? | Merged | `specs/spec-01-04-flows-autoref-review/` |
| `spec-01-05` | prd-critique | P? | Active | `specs/spec-01-05-prd-critique/` |
<!-- sdd:specs:end -->
